...
void vfcvt_x_f_v_i64_vec(int64_t* vd, double* vs2, int n) {
    int i;
...
void vfcvt_f_x_v_f32_vec(float* vd, int32_t* vs2, int n) {
    int i;
    ...
    for (i = 0; i < n;) {
        gvl = vsetvl_e32m1(n - i);
        _MMR_i32 v_vs2 = vle32_v_i32m1(&vs2[i], gvl);
        _MMR_f32 v_res = vfcvt_f_x_v_f32m1(v_vs2, gvl);
        vse32_v_f32m1(&vd[i], v_res, gvl);
        i += gvl;
    }
...
void vfcvt_f_x_v_f64_vec(double* vd, int64_t* vs2, int n) {
    int i;
...
void vdiv_vv_i64_vec(int64_t* vd, int64_t* vs2, int64_t* vs1, int n) {
    int i;
    ...
    for (i = 0; i < n;) {
        ...
        _MMR_i64 v_vs2 = vle64_v_i64m1(&vs2[i], gvl);
        _MMR_i64 v_res = vdiv_vv_i64m1(v_vs2, v_vs1, gvl);
        vse64_v_i64m1(&vd[i], v_res, gvl);
        i += gvl;
    }
...
void vdiv_vv_i32_vec(int32_t* vd, int32_t* vs2, int32_t* vs1, int n) {
    int i;
    ...
    for (i = 0; i < n;) {
        gvl = vsetvl_e32m1(n - i);
        _MMR_i32 v_vs1 = vle32_v_i32m1(&vs1[i], gvl);
        _MMR_i32 v_vs2 = vle32_v_i32m1(&vs2[i], gvl);
        _MMR_i32 v_res = vdiv_vv_i32m1(v_vs2, v_vs1, gvl);
        vse32_v_i32m1(&vd[i], v_res, gvl);
        i += gvl;
    }
...
void vmul_vv_i64_vec(int64_t* vd, int64_t* vs2, int64_t* vs1, int n) {
    int i;
    ...
    for (i = 0; i < n;) {
        ...
        _MMR_i64 v_vs1 = vle64_v_i64m1(&vs1[i], gvl);
        _MMR_i64 v_vs2 = vle64_v_i64m1(&vs2[i], gvl);
        _MMR_i64 v_res = vmul_vv_i64m1(v_vs2, v_vs1, gvl);
        vse64_v_i64m1(&vd[i], v_res, gvl);
        i += gvl;
    }
...
void vmul_vv_i32_vec(int32_t* vd, int32_t* vs2, int32_t* vs1, int n) {
    int i;
    ...
    for (i = 0; i < n;) {
        ...
        _MMR_i32 v_vs1 = vle32_v_i32m1(&vs1[i], gvl);
        _MMR_i32 v_vs2 = vle32_v_i32m1(&vs2[i], gvl);
        _MMR_i32 v_res = vmul_vv_i32m1(v_vs2, v_vs1, gvl);
        vse32_v_i32m1(&vd[i], v_res, gvl);
        i += gvl;
    }
...
void vadd_vv_i64_vec(int64_t* vd, int64_t* vs2, int64_t* vs1, int n) {
    int i;
    ...
    for (i = 0; i < n;) {
        ...
        _MMR_i64 v_vs1 = vle64_v_i64m1(&vs1[i], gvl);
        _MMR_i64 v_vs2 = vle64_v_i64m1(&vs2[i], gvl);
        _MMR_i64 v_res = vadd_vv_i64m1(v_vs2, v_vs1, gvl);
        vse64_v_i64m1(&vd[i], v_res, gvl);
        i += gvl;
    }
...
void vadd_vv_i32_vec(int32_t* vd, int32_t* vs2, int32_t* vs1, int n) {
    int i;
    ...
    for (i = 0; i < n;) {
        ...
        _MMR_i32 v_vs1 = vle32_v_i32m1(&vs1[i], gvl);
        _MMR_i32 v_vs2 = vle32_v_i32m1(&vs2[i], gvl);
        _MMR_i32 v_res = vadd_vv_i32m1(v_vs2, v_vs1, gvl);
        vse32_v_i32m1(&vd[i], v_res, gvl);
        i += gvl;
    }
...
void vadd_vv_i16_vec(int16_t* vd, int16_t* vs2, int16_t* vs1, int n) {
    int i;

    long gvl = vsetvl_e16m1(n);
...
void vadd_vv_i8_vec(int8_t* vd, int8_t* vs2, int8_t* vs1, int n) {
    int i;

    long gvl = vsetvl_e8m1(n);
...
void vsub_vv_i64_vec(int64_t* vd, int64_t* vs2, int64_t* vs1, int n) {
    int i;
    ...
    for (i = 0; i < n;) {
        ...
        _MMR_i64 v_vs1 = vle64_v_i64m1(&vs1[i], gvl);
        _MMR_i64 v_vs2 = vle64_v_i64m1(&vs2[i], gvl);
        _MMR_i64 v_res = vsub_vv_i64m1(v_vs2, v_vs1, gvl);
        vse64_v_i64m1(&vd[i], v_res, gvl);
        i += gvl;
    }
...
void vsub_vv_i32_vec(int32_t* vd, int32_t* vs2, int32_t* vs1, int n) {
    int i;
    ...
    for (i = 0; i < n;) {
        ...
        _MMR_i32 v_vs1 = vle32_v_i32m1(&vs1[i], gvl);
        _MMR_i32 v_vs2 = vle32_v_i32m1(&vs2[i], gvl);
        _MMR_i32 v_res = vsub_vv_i32m1(v_vs2, v_vs1, gvl);
        vse32_v_i32m1(&vd[i], v_res, gvl);
        i += gvl;
    }
...
//         _MMR_i64 v_vs1 = vle64_v_i64m1(&vs1[i], gvl);
//         _MMR_i64 v_vs2 = vle64_v_i64m1(&vs2[i], gvl);
//         vbool8_t v_vm = vle8_v_u8m1(&vm[i], gvl);
